...
interface MessageDao {
    ...
    @Query("SELECT * FROM messages WHERE roomId = :roomId AND type = 'system' AND content = :content ORDER BY createdAt DESC LIMIT 1")
    suspend fun findRecentSystemMessage(roomId: String, content: String): MessageEntity?
