...
path = f"{BASE}/screens/GroupChatScreen.kt"
if not os.path.exists(f"{BASE}/data/QuickReactionsStore.kt"):
    fail("QuickReactionsStore.kt not found -- run the ChatScreen patch first")
if not os.path.exists(f"{BASE}/screens/EmojiBottomSheet.kt"):
    fail("EmojiBottomSheet.kt not found -- run the ChatScreen patch first")
...
content = replace_once(content, old_import, new_import, "GroupChatScreen imports")
