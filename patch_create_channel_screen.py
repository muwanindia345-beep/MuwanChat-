# -*- coding: utf-8 -*-
# Naya file: CreateChannelScreen.kt -- CreateGroupScreen jaisa hi header/
# field/avatar-picker pattern (app-wide consistency ke liye same DarkHeader/
# DarkBg/DarkAccent styling reuse), bas "Add members" section hata diya --
# members add karna channel create hone ke baad, alag reused flow se hoga.
# "Confirm" abhi Coming Soon dialog dikhata hai (existing ComingSoonDialog
# component reuse) -- asli create-channel API call agle patch me wire hoga.
...
if os.path.exists(path):
    raise SystemExit(f"[FAIL] {path} already exists -- skipping to avoid overwrite")

content = '''package com.muwan.muwanchat.screens
